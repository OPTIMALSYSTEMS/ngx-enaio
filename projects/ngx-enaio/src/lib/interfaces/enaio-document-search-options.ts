...
export interface EnaioDocumentSearchOptions {
  ...
  page?: number;
  /**
   * Maximum number of hits to load. This can be more hits than specified in pagesize.
   * This can be used to regulate the caching so that subsequent pages are delivered faster.
   */
  maxhits?: number;
  /**
